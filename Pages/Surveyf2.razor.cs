...
{
    public partial class Surveyf2 : ComponentBase
    {
        ...
        class chksurveyb2
        {
            ...
            public bool f2_2_1 { get; set; }
            public bool f2_2_2 { get; set; }
            public bool f2_2_3 { get; set; }
            public bool f2_2_4 { get; set; }
            public bool f2_2_5 { get; set; }
            public bool f2_3_1 { get; set; }
            public bool f2_3_2 { get; set; }
            public bool f2_3_3 { get; set; }
            public bool f2_3_4 { get; set; }
            public bool f2_3_5 { get; set; }
            public bool f2_3_6 { get; set; }
            public bool f2_3_7 { get; set; }
            public bool f2_3_8 { get; set; }
            public bool f2_3_9 { get; set; }
            public bool f2_3_10 { get; set; }
            public bool f2_4_1 { get; set; }
            public bool f2_4_2 { get; set; }
            public bool f2_4_3 { get; set; }
            public bool f2_4_4 { get; set; }
            public bool f2_4_5 { get; set; }
            public bool f2_4_6 { get; set; }
            public bool f2_4_7 { get; set; }
            public bool f2_4_8 { get; set; }
        ...
        protected override async Task OnInitializedAsync()
        {
            ...
            formData.f2 = String.IsNullOrEmpty(formData.surveyTemp.f2) ? false : true;
            formData.f2_2_1 = String.IsNullOrEmpty(formData.surveyTemp.f2_2_1) ? false : true;
            formData.f2_2_2 = String.IsNullOrEmpty(formData.surveyTemp.f2_2_2) ? false : true;
            formData.f2_2_3 = String.IsNullOrEmpty(formData.surveyTemp.f2_2_3) ? false : true;
            formData.f2_2_4 = String.IsNullOrEmpty(formData.surveyTemp.f2_2_4) ? false : true;
            formData.f2_2_5 = String.IsNullOrEmpty(formData.surveyTemp.f2_2_5) ? false : true;
            formData.f2_3_1 = String.IsNullOrEmpty(formData.surveyTemp.f2_3_1) ? false : true;
            formData.f2_3_2 = String.IsNullOrEmpty(formData.surveyTemp.f2_3_2) ? false : true;
            formData.f2_3_3 = String.IsNullOrEmpty(formData.surveyTemp.f2_3_3) ? false : true;
            formData.f2_3_4 = String.IsNullOrEmpty(formData.surveyTemp.f2_3_4) ? false : true;
            formData.f2_3_5 = String.IsNullOrEmpty(formData.surveyTemp.f2_3_5) ? false : true;
            formData.f2_3_6 = String.IsNullOrEmpty(formData.surveyTemp.f2_3_6) ? false : true;
            formData.f2_3_7 = String.IsNullOrEmpty(formData.surveyTemp.f2_3_7) ? false : true;
            formData.f2_3_8 = String.IsNullOrEmpty(formData.surveyTemp.f2_3_8) ? false : true;
            formData.f2_3_9 = String.IsNullOrEmpty(formData.surveyTemp.f2_3_9) ? false : true;
            formData.f2_3_10 = String.IsNullOrEmpty(formData.surveyTemp.f2_3_10) ? false : true;
            formData.f2_4_1 = String.IsNullOrEmpty(formData.surveyTemp.f2_4_1) ? false : true;
            formData.f2_4_2 = String.IsNullOrEmpty(formData.surveyTemp.f2_4_2) ? false : true;
            formData.f2_4_3 = String.IsNullOrEmpty(formData.surveyTemp.f2_4_3) ? false : true;
            formData.f2_4_4 = String.IsNullOrEmpty(formData.surveyTemp.f2_4_4) ? false : true;
            formData.f2_4_5 = String.IsNullOrEmpty(formData.surveyTemp.f2_4_5) ? false : true;
            formData.f2_4_6 = String.IsNullOrEmpty(formData.surveyTemp.f2_4_6) ? false : true;
            formData.f2_4_7 = String.IsNullOrEmpty(formData.surveyTemp.f2_4_7) ? false : true;
            formData.f2_4_8 = String.IsNullOrEmpty(formData.surveyTemp.f2_4_8) ? false : true;
        ...
        protected async Task HandleValidSubmit(EditContext context)
        {
            ...
            formData.surveyTemp.f2 = formData.f2 ? "f2" : "";
            formData.surveyTemp.f2_2_1 = formData.f2_2_1 ? "1" : "";
            formData.surveyTemp.f2_2_2 = formData.f2_2_2 ? "2" : "";
            formData.surveyTemp.f2_2_3 = formData.f2_2_3 ? "3" : "";
            formData.surveyTemp.f2_2_4 = formData.f2_2_4 ? "4" : "";
            formData.surveyTemp.f2_2_5 = formData.f2_2_5 ? "5" : "";
            formData.surveyTemp.f2_3_1 = formData.f2_3_1 ? "1" : "";
            formData.surveyTemp.f2_3_2 = formData.f2_3_2 ? "2" : "";
            formData.surveyTemp.f2_3_3 = formData.f2_3_3 ? "3" : "";
            formData.surveyTemp.f2_3_4 = formData.f2_3_4 ? "4" : "";
            formData.surveyTemp.f2_3_5 = formData.f2_3_5 ? "5" : "";
            formData.surveyTemp.f2_3_6 = formData.f2_3_6 ? "6" : "";
            formData.surveyTemp.f2_3_7 = formData.f2_3_7 ? "7" : "";
            formData.surveyTemp.f2_3_8 = formData.f2_3_8 ? "8" : "";
            formData.surveyTemp.f2_3_9 = formData.f2_3_9 ? "9" : "";
            formData.surveyTemp.f2_3_10 = formData.f2_3_10 ? "10" : "";
            formData.surveyTemp.f2_4_1 = formData.f2_4_1 ? "1" : "";
            formData.surveyTemp.f2_4_2 = formData.f2_4_2 ? "2" : "";
            formData.surveyTemp.f2_4_3 = formData.f2_4_3 ? "3" : "";
            formData.surveyTemp.f2_4_4 = formData.f2_4_4 ? "4" : "";
            formData.surveyTemp.f2_4_5 = formData.f2_4_5 ? "5" : "";
            formData.surveyTemp.f2_4_6 = formData.f2_4_6 ? "6" : "";
            formData.surveyTemp.f2_4_7 = formData.f2_4_7 ? "7" : "";
            formData.surveyTemp.f2_4_8 = formData.f2_4_8 ? "8" : "";
            string hc = configSurvey.HC_noId(HC);
